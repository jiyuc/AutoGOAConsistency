...
class JointModelForSequenceClassification(BertPreTrainedModel):
    ...
    def __init__(self, config):
        ...
        #self.linear = nn.Linear(16, 768, bias=True)  # 768 dims of BERT, 16 dims of GO hier-KG
        self.classifier = nn.Linear(768+64, config.num_labels)  # |u,v, u*v, u-v|
        self.init_weights()
    ...
    def forward(
        ...
        concatenated_output = torch.cat([pooled_output, go_hier_encodings], dim=1)
        """
